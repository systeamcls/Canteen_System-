      ...
      <div class="space-y-6">
        <div class="space-y-4">
          ...
          <p class="hero-description">
            Explore all the incredible food vendors at LTO Canteen Central. Each stall offers unique specialties and authentic flavors.
          </p>
        </div>
          ...
          <div style="position: relative;">
            ...
            <form action="{{ route('stalls.index') }}" method="GET" id="search-form">
              <input 
                ...
                placeholder="Search stalls, dishes, or specialties..." 
                class="search-input"
                id="search-input"
              >
            </form>
        ...
        <div class="category-filters">
          <a href="{{ route('stalls.index') }}" class="category-btn {{ !request('search') && !request('category') ? 'active' : '' }}">All</a>
          <a href="{{ route('stalls.index', ['category' => 'Filipino']) }}" class="category-btn {{ request('category') === 'Filipino' ? 'active' : '' }}">Filipino</a>
          <a href="{{ route('stalls.index', ['category' => 'Chinese-Filipino']) }}" class="category-btn {{ request('category') === 'Chinese-Filipino' ? 'active' : '' }}">Chinese-Filipino</a>
          <a href="{{ route('stalls.index', ['category' => 'Fresh Market']) }}" class="category-btn {{ request('category') === 'Fresh Market' ? 'active' : '' }}">Fresh Market</a>
          <a href="{{ route('stalls.index', ['category' => 'Services']) }}" class="category-btn {{ request('category') === 'Services' ? 'active' : '' }}">Services</a>
          <a href="{{ route('stalls.index', ['category' => 'Snacks & Beverages']) }}" class="category-btn {{ request('category') === 'Snacks & Beverages' ? 'active' : '' }}">Snacks & Beverages</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
            ...
            <div class="stall-content">
              ...
              <div class="stall-meta">
                ...
                <div class="meta-rating">
                  <svg class="star-icon" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2">
              ...
              <div class="stall-info">
                <span class="text-muted-foreground">{{ $stall->products->where('is_available', true)->count() }} items • </span>
                <span class="text-primary">₱80-150</span>
              </div>

              <div class="stall-actions">
                <a href="{{ route('stalls.show', $stall) }}" class="btn btn-primary">View Menu</a>
                <a href="{{ route('menu.index', ['stall' => $stall->id]) }}" class="btn btn-outline">Quick Order</a>
              </div>
            </div>
          </div>
          @endforeach
      ...
      @else
        <div class="no-results">
          ...
          <a href="{{ route('stalls.index') }}" class="btn btn-outline" style="display: inline-block; margin-top: 1rem;">
            Clear Filters
          </a>
          @endif
        </div>
    ...
    <div class="container">
      ...
      <div class="stats-grid">
        ...
        <div class="stat-card">
          ...
          <div class="stat-value">₱{{ number_format(App\Models\Product::where('is_available', true)->avg('price'), 0) }}</div>
