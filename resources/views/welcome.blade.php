        ...
        * {
        ...
        .hero::before {
            ...
            background: linear-gradient(135deg,
                    ...
                    /* Orange with 85% opacity */
                    rgba(251, 146, 60, 0.75) 50%,
                    /* Lighter orange with 75% opacity */
        ...
        /* Floating Label Styles for Welcome Modal */
        .floating-form-group {
            position: relative;
            margin-bottom: 24px;
        }
        ...
        .back-btn-header {
            position: absolute;
            top: 16px;
            /* ← Changed from 20px to 16px (higher) */
            left: 16px;
            /* ← Changed from 20px to 24px (more left padding) */
            background: none;
            border: none;
            color: #FF6B47;
            font-size: 0.9rem;
        ...
        .modal-header {
            ...
            /* Space for back button and close button */
            text-align: center;
        }
        ...
        /* Better Compact Password Requirements */
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                ...
                <p>Discover amazing food from multiple vendors in one place. Fresh meals, quick service, and delicious
                    options for everyone - visitors and LTO employees alike.</p>
                <div class="cta-buttons">
                    <button onclick="openWelcomeModal()" class="btn btn-primary"
                        style="border: none; cursor: pointer;">🛒 Browse Menu</button>
    ...
    <section class="testimonials" id="testimonials">
        <div class="container">
            ...
            <div class="testimonial-grid">
                ...
                <div class="testimonial-card">
                    <p class="testimonial-text">"As a visitor, I appreciate how quick and easy it is to get a good meal
                        while waiting for my transaction."</p>
                    <p class="testimonial-author">- Ajo W., LTO Visitor</p>
                </div>
                <div class="testimonial-card">
                    <p class="testimonial-text">"Shoutout, Ang smooth ng website and ang sarap ng food Atakeee ang
                        foods."</p>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-column">
                    ...
                    <p style="color: #fed7aa; margin-top: 10px; line-height: 1.6;">Your one-stop food destination at
                        LTO. Fresh meals, quick service, and delicious options for everyone.</p>
