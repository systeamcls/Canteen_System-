    ...
    <x-filament::section>
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <a href="/cashier/pos-system"
                ...
                <div
                    class="flex items-center justify-center w-12 h-12 bg-green-500 rounded-full mb-3 group-hover:bg-green-600 transition-colors">
            ...
            <a href="/cashier/orders"
                ...
                <div
                    class="flex items-center justify-center w-12 h-12 bg-blue-500 rounded-full mb-3 group-hover:bg-blue-600 transition-colors">
            ...
            <a href="/cashier/products"
                ...
                <div
                    class="flex items-center justify-center w-12 h-12 bg-orange-500 rounded-full mb-3 group-hover:bg-orange-600 transition-colors">
            ...
            <button onclick="window.location.reload()"
                ...
                <div
                    class="flex items-center justify-center w-12 h-12 bg-gray-500 rounded-full mb-3 group-hover:bg-gray-600 transition-colors">
