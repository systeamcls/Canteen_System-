            ...
            <div class="desktop-container">
                ...
                <div class="desktop-profile-header fade-in">
                    ...
                    <div class="desktop-profile-info">
                        <div class="desktop-avatar">{{ strtoupper(substr($user->name, 0, 2)) }}</div>
                        ...
                        <div class="profile-card">
                            ...
                            <div style="display: flex; align-items: center; gap: 2rem; margin-bottom: 2rem;">
                                <div style="position: relative;">
                                    <div class="desktop-avatar" style="width: 100px; height: 100px; font-size: 2rem;">
                                        {{ strtoupper(substr($user->name, 0, 2)) }}
                                    </div>
                                    <div style="position: absolute; bottom: -10px; left: 50%; transform: translateX(-50%);">
                                        <div class="desktop-user-badge" style="margin: 0; font-size: 0.75rem;">
                                ...
                                <div style="flex: 1;">
                                    <div style="display: flex; flex-direction: column; gap: 1rem;">
                                        ...
                                        <div style="display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem 0;">
                                            ...
                                            <span style="color: var(--text-dark); font-weight: 500;">{{ $user->phone }}</span>
                                        </div>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="recent-updates-section">
                            ...
                            <div class="recent-update-item">
                                ...
                                <div style="display: flex; align-items: center; gap: 1rem;">
                                    ...
                                    <div class="recent-update-amount">₱{{ number_format($order->total_amount, 2) }}</div>
                                </div>
                            </div>
                            @empty
                    ...
                    <div class="desktop-tab-content" id="desktop-orders-tab">
                        <div class="orders-summary">
                            ...
                            <div class="summary-card">
                                ...
                                <div class="summary-number">₱{{ number_format($user->orders()->sum('total_amount'), 0) }}</div>
                        ...
                        <div class="order-item" data-order-id="{{ $order->id }}">
                            <div class="order-info">
                                ...
                                <div class="order-meta">
                                    ...
                                    <span><i class="fas fa-peso-sign"></i> ₱{{ number_format($order->total_amount, 2) }}</span>
                                </div>
                            </div>
                            <div>
            ...
            <div class="mobile-container">
                ...
                <div class="mobile-profile-card">
                    ...
                    <div class="mobile-profile-info">
                        <div class="mobile-avatar">{{ strtoupper(substr($user->name, 0, 2)) }}</div>
                ...
                <div class="mobile-content">
                        ...
                        <div class="mobile-card">
                            ...
                            <div class="recent-update-item">
                                ...
                                <div style="display: flex; align-items: center; gap: 0.5rem; flex-direction: column; text-align: right;">
                                    <div class="order-status status-{{ strtolower($order->status) }}">{{ ucfirst($order->status) }}</div>
                                    <div class="recent-update-amount" style="font-size: 0.875rem;">₱{{ number_format($order->total_amount, 2) }}</div>
                                </div>
                            </div>
                            @empty
                            <div style="text-align: center; padding: 2rem; color: var(--text-muted);">
                    ...
                    <div class="mobile-tab-content" id="mobile-orders-tab">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; margin-bottom: 1.5rem;">
                            ...
                            <div class="mobile-card" style="text-align: center; padding: 1rem;">
                                <div style="font-size: 1rem; font-weight: 700; color: var(--primary-orange); margin-bottom: 0.25rem;">₱{{ number_format($user->orders()->sum('total_amount'), 0) }}</div>
                        ...
                        <div class="mobile-card">
                            ...
                            <div class="order-item" style="padding: 1rem 0; border-bottom: 1px solid var(--border); margin-bottom: 0;">
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    ...
                                    <div style="text-align: right;">
                                        <div style="font-weight: 700; margin-bottom: 0.25rem;">₱{{ number_format($order->total_amount, 2) }}</div>
                                        <div class="order-status status-{{ strtolower($order->status) }}">{{ ucfirst($order->status) }}</div>
                                    </div>
                                </div>
                            </div>
